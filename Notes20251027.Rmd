...
Calculate the Spearman correlation and Kendall tau metric for head size and stat_likert variable (it was the answer to the question do you think statistics is difficult with Likert scale as the answer):
